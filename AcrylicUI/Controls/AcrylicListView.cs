...
{
    public class AcrylicListView : AcrylicScrollView
    {
        #region Event Region
        ...
        public ObservableCollection<AcrylicListItem> Items
        {
            get { return _items; }
            set
            {
        ...
        private void Items_CollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (e.NewItems != null)
            {
                using (var g = CreateGraphics())
                {
                    ...
                    foreach (AcrylicListItem item in e.NewItems)
                    {
            ...
            if (e.OldItems != null)
            {
                foreach (AcrylicListItem item in e.OldItems)
                    item.TextChanged -= Item_TextChanged;
        ...
        {
            var item = (AcrylicListItem)sender;
        ...
        public int GetItemIndex(AcrylicListItem item)
        {
        ...
        private void UpdateItemSize(AcrylicListItem item)
        {
            using (var g = CreateGraphics())
            {
                UpdateItemSize(item, g);
        ...
        private void UpdateItemSize(AcrylicListItem item, Graphics g)
        {
        ...
        private IEnumerable<AcrylicListItem> ItemsInView()
        {
